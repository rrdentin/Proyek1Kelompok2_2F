<div class="modal fade" id="createPanitia" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('users.store') }}">
                    ...
                    <input type="hidden" name="level" value="panitia">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary">Add Panitia</button>
                </form>
            </div>
        </div>
    </div>
