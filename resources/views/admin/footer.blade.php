    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-lg-end">
                <a class="link-light text-decoration-none me-3" href="#" style="color: white;">Privacy Policy</a>
                <a class="link-light text-decoration-none" href="#" style="color: white;">Terms of Use</a>
            </div>
        </div>
    </div>
</footer>