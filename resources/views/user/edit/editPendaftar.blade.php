            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('pendaftar.update', $pendaftar->id) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nik" name="nik" value="{{ $pendaftar->nik }}"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="name" class="form-label">Nama Calon Siswa:</label>
                        <input type="text" class="form-control" id="name" name="name" value="{{ $pendaftar->name }}"
                            required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary"
                            onclick="confirmUpdate({{ $pendaftar->id }})">Update Calon Siswa</button>
                    </div>
                </form>
            </div>
        </div>
